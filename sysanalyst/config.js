/* ============================================================
   SAA — System Analyst Assessment · merchant / paywall config
   ...
   ============================================================ */
window.MMAT_CONFIG = {
  /* ---- pricing shown on the paywall ---- */
  product:   "System Analyst Assessment — Full Access",
  price:     "$17.99",
  priceNote: "one-time payment · all 10 assessments + strategy guide · lifetime access",
  subPrice:  "$5.99/mo",
  ...
  */
  paywall: {
    provider: "code",
    accessCodes: ["ARISTOTLE-ALL-ACCESS", "SAA-FREE-2026"],
  ...
  analytics: {
    plausibleDomain: "",  // e.g. "sysanalystassessment.com" → loads Plausible

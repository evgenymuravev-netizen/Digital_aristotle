...
{g:'Debt intelligence ✦', items:[
  ...
  S('SME — who signs + reused KYC','Pick the authorized signatory; Khadeeja already passed retail KYC — nothing to upload',()=>{A.tmp.smev=2;A.tmp.smeSig=0;A.go('sme-video');}),
  S('SME — documents & UBOs','Licence, MoA, AoA as PDF uploads; non-signatory UBOs upload EID + passport too',()=>{A.tmp.smev=4;A.tmp.smeSig=0;A.tmp.smeDocs={};A.go('sme-video');}),

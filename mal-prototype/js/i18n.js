...
'Send money':'إرسال الأموال','Invest':'الاستثمار','Mal Gold':'ذهب «مال»','AECB score':'تقييم AECB',
...
'Products':'المنتجات','New goal':'هدف جديد','Mal Rules':'قواعد «مال»','New rule':'قاعدة جديدة',
...
'Above nisab — zakat due ✓':'فوق النصاب — الزكاة واجبة ✓','Seen by Mal (live)':'ما يراه «مال» (مباشر)',
...
/* chat */
'Mal AI':'«مال» AI','● agent online · acts with your approval':'● الوكيل متصل · يتصرف بموافقتك',
...
const R = [
  ...
  [/^☪ Total zakat due · (.+) method$/, (m,g)=>'☪ إجمالي الزكاة · طريقة '+(D[g]||g)],
...
window.AR_WELCOME = [
  {h:'تحكَّم في ثروتك<br><span class="lime-t">عبر البنوك والتطبيقات المالية</span>', d:'كل بنك ومحفظة وخطة دفع آجل ودَين ودرهم — صورة حيّة واحدة، ورقم واحد تثق به.'},
  ...
  {h:'تحكَّم في ثروتك<br><span class="lime-t">بلا حدود</span>', d:'الخدمات المصرفية المفتوحة في الإمارات والسعودية وبريطانيا — وحيث لا توجد بعد، يقرأ «مال» كشوف الحساب من بريدك. العائلات الكبيرة تعيش عبر الحدود؛ وصورة أموالك لا يجب أن تتوقف عند حدود دولة واحدة.'},

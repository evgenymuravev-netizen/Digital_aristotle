...
SCREENS.home = () => `
  <div class="scr" style="padding-bottom:170px">
    ...
    <div class="card hero-blue mt16 tap" onclick="A.go('money')">
      <div class="flex between">
    ...
    <div class="card mt12 tap" onclick="A.go('goals')">
      ...
      <div class="flex mt8" style="gap:14px">
        <div class="f1"><div class="micro">Hajj · Emergency · Car · Umrah</div><div class="mt4">${meter(GOAL_STATS.pct/100,'#FF6757')}</div></div>
    ...
    <div class="hscroll">
      <div class="card lime tap" style="min-width:218px" onclick="A.go('chat-card')">
        ...
        <div class="h3 mt8">Noor Agentic card · AED 20,000</div>
...
SCREENS.briefing = () => `
  <div class="scr">
    ...
    <button class="btn ghost mt16" onclick="A.go('chat')">${aiIc(13)} Ask Noor anything</button>
  </div>`;
...
SCREENS.money = () => {
  ...
  const groups = [
    ...
    {bank:'noor',accs:ACCOUNTS.filter(a=>a.bank==='noor'&&!a.biz), label:'Held with Noor'},
  ...
  <div class="scr" style="padding-bottom:170px">
    ...
    <div class="card lime mt16 tap" onclick="A.go('debts')">
      ...
      <div class="micro mt4">Close the 14.5% invoice line · move Murabaha & PO to Noor deposit-secured — full read in Debts</div>
    </div>
  ...
  <div class="scr ch-scr">
    <div class="apphdr">
      ...
      <div style="flex:1;text-align:center">
        <div class="h3 flex" style="justify-content:center;gap:7px">${aiIc(13)}Noor AI</div>

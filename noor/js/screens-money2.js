...
SCREENS.request = () => `
  <div class="scr">
    ...
    <div class="btnrow mt12">
      <button class="btn ghost" onclick="A.toast('Payment link copied: noor.finance/p/john','link')">${ic('link',18)} Copy link</button>
...
SCREENS.subs = () => {
  ...
  <div class="scr">
    ...
    <div class="card mt12" style="border-color:rgba(127,176,255,.45)">
    ...
    <div class="card mt12" style="border-color:rgba(255,103,87,.35)">
...
SCREENS.global = () => `
  <div class="scr">
    ...
    <button class="btn ghost mt12" onclick="A.toast('Statement forwarding address created: khadeeja.statements@noor.finance','check')">Add a country — forward statements by email</button>
  </div>`;
...
SCREENS.plan = () => `
  <div class="scr">
    ...
    <div class="micro mt12" style="text-align:center">Noor earns on the two refinancing steps (≈ AED 950/yr) and nothing on the rest. Shown because trust compounds.</div>
  </div>`;
...
window.HardStop = {
  demo(){
    ...
    setTimeout(()=>{ A.sheet(`
      ...
      <div class="card soft mt12"><div class="kv"><span class="k">Arabica Coffee · DIFC</span><span class="v tnum">AED 68.00</span></div><div class="micro">Noor Agentic card · 21:14 · Dining & cafés</div></div>
  ...
  render(){
    ...
    host.innerHTML = `
      <div class="story" onclick="Story.next()">
        ...
        <div class="glowblob" style="background:#7FB0FF;bottom:-90px;right:-90px;opacity:.18"></div>

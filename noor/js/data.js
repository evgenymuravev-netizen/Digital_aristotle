...
window.ACCOUNTS = [
  ...
  {id:'inv',      bank:'noor',kind:'invest',  name:'Noor Portfolio',      mask:'',     bal:38500.00},
...
ACCOUNTS.push(
  ...
  {id:'mb-fin', bank:'mashreq', biz:true, kind:'finance', name:'Business financing · Murabaha', bal:-45000, left:'9.2% → Noor deposit-secured 4.95%'},
...
window.SUBS = [
  ...
  {m:'du Home Internet',amt:389.00,day:'3rd', next:'3 Jul',    ic:'zap',   c:'#FF6757', acc:'fab-cc', used:'Essential'},
  ...
  {m:'ChatGPT Plus',   amt:73.41, day:'31st', next:'30 Jun',   ic:'spark', c:'#E2543F', acc:'fab-cc', used:'Used daily'},
...
window.UPCOMING = [
  ...
  {t:'DEWA · autopay', d:'15 Jun', amt:412.60, ic:'zap', c:'#FF6757', acc:'FAB ··5689'},
...
window.BRIEFING = {
  ...
  items:[
    ...
    {ic:'doc',  c:'#FF6757', t:'Send trip documents', d:'Emirates booking RF8Q2P · visa copies due today 18:00', cta:'Open checklist', act:'done'},
...
window.GOALS = [
  ...
  {id:'car',   n:'New car',          em:'🚙', cur:22000, tgt:85000, by:'Mar 2028', auto:'Round-ups ×10', c:'#FF6757'},
  {id:'umrah', n:'Umrah with family',em:'🌙', cur:4200,  tgt:15000, by:'Apr 2027 · ~3 weeks late on current dining', auto:'AED 500 / month', c:'#E2543F', delay:true},
];
...
/* ---------- billers ---------- */
window.BILLERS = [
  {n:'DEWA', d:'Electricity & water', ic:'zap', c:'#FF6757', due:412.60, autopay:true},
  {n:'Etisalat e&', d:'Mobile · 050 482 7791', ic:'phone', c:'#1f8a5b', due:289.00, autopay:false},
  {n:'du Home', d:'Internet · account 884512', ic:'globe', c:'#E2543F', due:389.00, autopay:true},
...
window.GLOBAL_WEALTH = {
  ...
  note:'Big families live across borders. Where open banking exists, Noor connects it; where it doesn’t, the inbox watchdog parses statement PDFs — same categories, same zakat estate, one picture.'
};
...
window.INVEST = {
  total:38500, day:+1.24, positions:[
    ...
    {n:'MSCI World Islamic ETF', d:'Global equity · Halal screened', amt:12400, chg:+4.8, c:'#FF6757', em:'🌍'},
    {n:'US Stocks (Halal)', d:'AAPL · MSFT · TSLA via screen', amt:5100, chg:-1.2, c:'#E2543F', em:'📈'},
  ],
...
window.DEBTS = [
  ...
  {id:'car',    t:'Car finance (Murabaha)',       bank:'dib',     out:36200,  rate:5.90, monthly:1640, kind:'Personal', costYr:2136,
   rec:'transfer', to:'Noor auto refinancing · 4.49%', save:510, malRev:440, why:'Same car, lower profit rate — settled & re-papered in one tap.'},
  {id:'pers',   t:'Personal finance (Murabaha)',  bank:'ei',      out:18000,  rate:8.50, monthly:660,  kind:'Personal', costYr:1530,
   rec:'transfer', to:'Noor deposit-secured · 4.25%', save:765, malRev:310, why:'Your e-Saver pledges as rahn — rate nearly halves while savings keep earning 3.1%.'},
  ...
  {id:'bizfin', t:'Business financing (Murabaha)',bank:'mashreq', out:45000,  rate:9.20, monthly:2750, kind:'Business', costYr:4140,
   rec:'transfer', to:'Noor deposit-secured business · 4.95%', save:1912, malRev:765, why:'Pledge part of your deposit — profit rate drops by nearly half.'},
  {id:'po',     t:'Purchase financing (PO)',      bank:'mashreq', out:12500,  rate:11.00,monthly:0,    kind:'Business', costYr:1375,
   rec:'transfer', to:'Noor purchase financing · 6.9%', save:512, malRev:185, why:'Stock finance at a sane rate, repaid as inventory sells.'},
...
/* ---------- notifications ---------- */
window.NOTIFS = [
  {ic:'zap', c:'#FF6757', t:'Agentically better — promise kept', d:'FAB upgraded their card campaign yesterday. Your Noor Agentic card matched it within the hour — only for you.', when:'1 h ago', act:'agentic-match'},
  ...
  {ic:'gift',  c:'#E2543F', t:'You earned a scratch card', d:'5-day saving streak — keep it up!', when:'Yesterday', act:'rewards'},
...
window.QARD = { capPct:10, salary:32500, cap:3250,
  why:'Qard Hasan may never earn the lender anything — any benefit tied to it is riba. Noor offers it anyway, because your salary relationship is worth more to us than fee income.' };
...
window.SME2 = {
  ubos:[
    {n:'Khadeeja AlMansoori', role:'Founder · 60%'},
    {n:'Omar AlFardan',       role:'Partner · 40%'},
  ],
  offer:{ limit:100000, currency:'AED', rate:18, profit:18000, inst:2950, period:'40 weeks',
          start:'14 Apr 2025', final:'18 Jan 2026', type:'Murabaha', commodity:'Platinum', pay:'Direct debit' },
  merchant:{ legal:'AlMansoori Trading LLC', unified:'723743884',
             iban:'AE85 0000 1234 5678 9012 3456', addr:'Unit 12, Al Quoz 3, Dubai, UAE',
             email:'khadeeja.almansoori@gmail.com' },
  signdocs:[
    ['Sellers offer','13:30:12'],
    ['Purchasers acceptance','13:30:14'],
    ['Holding certificate','13:30:15'],
    ['Base holding certificate','13:30:16'],
    ['Invoice of sale','13:30:17'],
    ['Murabaha agreement','13:30:18'],
    ['Purchasers offer','13:30:19'],
    ['Sellers acceptance','13:30:20'],
    ['Purchase order','13:30:21'],
...
window.MARKET = [
  ...
  {id:'ujrah', t:'Noor Ujrah Card', d:'Revolving · flat ujrah, no interest', ic:'card', c:'#0e0e10'},
  {id:'smev',  t:'SME financing — by video', d:'AED 100,000 · your shop and your story decide', ic:'cam', c:'#FF6757'},
  {id:'cards', t:'Credit cards', d:'3 pre-approved', ic:'card', c:'#FF6757'},
  ...
  {id:'home',  t:'Home finance', d:'Ijarah · from 3.99%', ic:'home', c:'#E2543F'},

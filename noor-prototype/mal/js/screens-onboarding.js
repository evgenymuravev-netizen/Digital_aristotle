...
SCREENS['ob-pin'] = () => `
  <div class="scr">
    ...
    <div class="sub mt8">6 digits — your key to Mal on this device.</div>
...
SCREENS['ob-notif'] = () => `
  <div class="scr center">
    ...
    <div class="card mt20" style="width:100%;max-width:320px;text-align:left">
      <div class="h3" style="text-align:center">“mal” would like to send you notifications</div>
...
SCREENS['ob-quiz'] = () => {
  ...
  <div class="scr">
    ${hdr('Almost there')}
    <div class="h1">What brings you<br>to Mal?</div>

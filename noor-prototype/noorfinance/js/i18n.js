...
'My money':'أموالي','Balance':'الرصيد','Personal':'شخصي','Business':'أعنور','Black & white mode':'الوضع الأبيض والأسود','Budget':'الميزانية','Trends for June':'اتجاهات شهر يونيو',
...
'⚡ Pre-approved':'⚡ موافقة مسبقة','Noor Agentic card · AED 20,000':'بطاقة «نور» الوكيلة · 20,000 د.إ',
...
'Available balance':'الرصيد المتاح','Held with Noor':'لدى «نور»','DIB · financing':'DIB · التمويل',
...
'Cashflow forecast':'توقعات التدفق النقدي','Financial health':'الصحة النورية','Round-ups → Gold':'تقريب المشتريات ← ذهب',
/* buttons & common */
...
'Gold jewellery (personal use)':'مصوغات ذهبية (استعنور شخصي)','Silver':'الفضة','Money owed to me (strong debts)':'ديون لي (مرجوّة السداد)',
...
const R = [
  ...
  [/^☪ Total zakat due · (.+) method$/, (m,g)=>'☪ إجنوري الزكاة · طريقة '+(D[g]||g)],
...
const AR_BRIEFING = {
  ...
  items:[
    ...
    {ic:'doc',  c:'#FF6757', t:'أرسل مستندات الرحلة', d:'حجز طيران الإمارات RF8Q2P · نسخ التأشيرة مطلوبة اليوم 18:00', cta:'افتح القائمة'},
...
window.AR_WELCOME = [
  {h:'تحكَّم في ثروتك<br><span class="lime-t">عبر البنوك والتطبيقات النورية</span>', d:'كل بنك ومحفظة وخطة دفع آجل ودَين ودرهم — صورة حيّة واحدة، ورقم واحد تثق به.'},
  ...
  {h:'تحكَّم في ثروتك<br><span class="lime-t">بلا حدود</span>', d:'الخدمات المصرفية المفتوحة في الإمارات والسعودية وبريطانيا — وحيث لا توجد بعد، يقرأ «نور» كشوف الحساب من بريدك. العائلات الكبيرة تعيش عبر الحدود؛ وصورة أموالك لا يجب أن تتوقف عند حدود دولة واحدة.'},
